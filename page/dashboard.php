...
<div class="h-screen">
    <div class="grid grid-cols-12 gap-5 w-[90%] flex mx-auto py-8 text-white">
        <a href="/himatikadmin/admin" class="col-span-3 ">
            <div class="h-32 bg-blue-600 w-full rounded-lg p-3">
                <h2 class="text-center text-[1.5rem] w-full bg-white text-black rounded-md">Total Admin</h2>
                <p class="text-center text-[2.8rem]"><?= $totalAdmin; ?></p>
            </div>
        </a>
        <a href="/himatikadmin/pengurus" class=" col-span-3 ">
            <div class=" h-32 bg-blue-600 w-full rounded-lg p-3">
                <h2 class="text-center text-[1.5rem] w-full bg-white text-black rounded-md">Total Pengurus</h2>
                <p class="text-center text-[2.8rem]"><?= $totalPengurus; ?></p>
            </div>
        </a>
        <a href="" class="col-span-3 ">
            <div class="h-32 bg-blue-600 w-full rounded-lg p-3">
                <h2 class="text-center text-[1.5rem] w-full bg-white text-black rounded-md">Total Galeri</h2>
                <p class="text-center text-[2.8rem]"><?= $totalGaleri; ?></p>
            </div>
        </a>
        <a href="" class="col-span-3 ">
            <div class="h-32 bg-blue-600 w-full rounded-lg p-3">
                <h2 class="text-center text-[1.5rem] w-full bg-white text-black rounded-md">Total Artikel</h2>
    ...
    <div class="grid grid-cols-12 gap-5 w-[90%] flex mx-auto py-8 text-white">
        <a href="" class="col-span-3 ">
            <div class="h-32 bg-blue-600 w-full rounded-lg p-3">
                <h2 class="text-center text-[1.5rem] w-full bg-white text-black rounded-md">Total Proker</h2>
                <p class="text-center text-[2.8rem]"><?= $totalProker; ?></p>
            </div>
        </a>
        <a href="" class="col-span-3 ">
            <div class="h-32 bg-blue-600 w-full rounded-lg p-3">
                <h2 class="text-center text-[1.5rem] w-full bg-white text-black rounded-md">Total Pesan</h2>
